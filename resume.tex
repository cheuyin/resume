...
\color{black}
  \resumeSubHeadingListStart
    \resumeSubheading
      {The University of British Columbia $|$ GPA: 4.30/4.33}{September 2022 -- May 2026}
      {B.Sc, Major in Computer Science}{Vancouver, BC}
      \resumeItemListStart 
        \resumeItem{\textbf{Courses}: Machine Learning, Relational Databases, Algorithms \& Data Structures, Computer Systems \& Hardware, Object-Oriented Programming}
...
\color{black}
    ...
    {\textbf{Pathfinding Visualizer \href{https://pathfindingvisualizer.com}{\faLink}} $|$ TypeScript, React, GitHub Actions, Mantine, Styled Components}{August 2024}
      ...
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{TwoChess \href{https://github.com/cheuyin/two-chess}{\faLink}} $|$ Java, JUnit, Swing}{April 2023}
          \resumeItemListStart
