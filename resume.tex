...
\color{black}
  \resumeSubHeadingListStart
    \resumeSubheading
      {The University of British Columbia $|$ GPA: 3.89/4.00}{Sep. 2022 -- May 2027}
...
\color{black}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Full Stack Developer $|$ \normalfont\emph{React, TypeScript, Express.js, PostgreSQL, AWS}}{Jan. 2024 -- Jul. 2024}
  ...
  \resumeSubheading
      {Mobile Developer (Volunteer) $|$ \normalfont\emph{React Native, Figma}}{Jun. 2023 -- Oct. 2023}
      {Eat n' Log } {Vancouver, BC}
      \resumeItemListStart
        \resumeItem{Worked with a multidisciplinary team of 15 using the Scrum methodology to develop the beta for a cross-platform mobile app, enabling food lovers to seamlessly document and share their favourite dishes and dining experiences.}
        \resumeItem{Independently developed five core UI features with React Native: search bar, filters by categories, home screen, authentication flow, and editable user entry pages.}
    	\resumeItemListEnd
...
\color{black}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Image Compression Tool} $|$ C++}{Jul. 2023}
          \resumeItemListStart
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{TwoChess} $|$ \emph{Java, JUnit, Swing}}{Apr. 2023}
          \resumeItemListStart
