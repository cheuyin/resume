...
\color{black}
  \resumeSubHeadingListStart
    \resumeSubheading
      {The University of British Columbia $|$ GPA: 3.89/4.00}{September 2022 -- May 2027}
...
\color{black}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Full Stack Developer $|$ \normalfont\emph{React, TypeScript, Express.js, PostgreSQL, AWS}}{January 2024 -- July 2024}
  ...
  \resumeSubheading
      {Mobile Developer (Volunteer) $|$ \normalfont\emph{React Native, Figma}}{June 2023 -- October 2023}
...
\color{black}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{TwoChess} $|$ \emph{Java, JUnit, Swing}}{April 2023}
          \resumeItemListStart
